...
namespace Drupal\entity_form_delegate\Form;

use Drupal\Core\Entity\EntityInterface;
use Drupal\Core\Form\FormStateInterface;
use Drupal\entity_form_delegate\EntityFormDelegateManager;
use Drupal\entity_form_delegate\Event\EntityFormInitEvent;

/**
 * Node form replacement that delegates the primary methods to alter plugins.
 *
 * @package Drupal\node_form_delegate\Form
 */
trait EntityFormDelegationTrait {
   ...
   *
   * @var \Drupal\entity_form_delegate\EntityFormDelegateManager
   */
   ...
   *
   * @param \Drupal\entity_form_delegate\EntityFormDelegateManager $delegateManager
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    // @see \Drupal\entity_form_delegate\EntityTypeManager.
  ...
  /**
   * Calls method on all node form alter plugins.
   *
   * @param string $method
   ...
   *
   * @param \Drupal\entity_form_delegate\EntityFormDelegatePluginInterface[] $alterPlugins
   *   The alter plugins.
   *
   * @return bool
   ...
   *   The current form state.
   *
   * @return \Drupal\entity_form_delegate\EntityFormDelegatePluginInterface[]
   *   The alter plugins.
   */
