...
namespace Drupal\entity_form_delegate\Event;
 ...
 *
 * @package Drupal\entity_form_delegate\Event
 */
class EntityFormInitEvent extends Event {
  ...
  public function setFormDisplay($displayId) {
    ...
    if (!$form instanceof ContentEntityForm) {
      \Drupal::logger('entity')->notice($this->t('Only fieldable entities have form modes. Tried to set form mode for entity of type @label', [
