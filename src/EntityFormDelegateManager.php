...
class EntityFormDelegateManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct(
      ...
      $namespaces,
      $module_handler,
      'Drupal\entity_form_delegate\EntityFormDelegatePluginInterface',
      'Drupal\entity_form_delegate\Annotation\EntityFormDelegate'
    );

    $this->setCacheBackend($cache_backend, 'entity_form_delegates');
  }
